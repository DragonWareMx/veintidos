        ...
        <div class="card-body">
          <div class="div-info-cuenta">
            <div class="div-foto-cuenta">
              ...
              <div><a href="javascript:cerrar();" class="a-cerrar-sesion" data-bs-toggle="modal" data-bs-target="#editar-datos">Editar datos<img src="{{ asset('img/sistema/edit.png')}}" style="height:12px; width: 13px; margin-left:10px; margin-bottom:2px" alt=""></a></div>
            </div>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body" style="font-weight: 400; color:#8c8d8f">
            <div class="mb-3">
              ...
              <input type="text" class="form-control" style="width: 100%" id="nombre" placeholder="José Agustín Aguilar Solórzano">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3"> 
              <label class="form-label" id="txt-editarC"><a href="javascript:editar();" style="color: #222B58;">Cambiar contraseña</a></label>
            </div>
