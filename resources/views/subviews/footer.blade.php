<footer>
    <div class="container-body">
        ...
        <div class="column2">
            <h4>PROPIEDADES</h4>
            <a href="" class="enlace-footer">Compra</a>
            <a href="" class="enlace-footer">Renta</a>
            <a href="" class="enlace-footer">Casas</a>
            <a href="" class="enlace-footer">Terrenos</a>
            <a href="" class="enlace-footer">Departamentos</a>
        </div>
        <div class="column3">
            <h4>NOSOTROS</h4>
            <a href="" class="enlace-footer">¿Quiénes somos?</a>
            <br><br>
            <h4>CONTÁCTANOS</h4>
        ...
        <div class="column4">
            <a href=""><img src="{{ asset('/img/ico/fb.png') }}"></a>
            <a href=""><img src="{{ asset('/img/ico/ig.png') }}"></a>
    ...
    <div class="container-footer">
        ...
        <p>Desarrollado por DragonWare.</p>
    </div>
</footer>